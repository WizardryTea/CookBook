...
const recipes = [
  {
    ...
    ingredients: [
      ...
      { name: 'лавровый лист', quantity: 0.1, unit: 'шт' },
      { name: 'яйца', quantity: 0.3, unit: 'шт' },
      { name: 'картошка', quantity: 0.2, unit: 'кг' }
    ],
    type: 'первые блюда',
  ...
  },
  {
    ...
    imgName: 'img-food/potatoes.png',
    ingredients: [
      { name: 'картофель', quantity: 800, unit: 'г' },
      { name: 'репчатый лук', quantity: 1, unit: 'шт' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'картофель', quantity: 1000, unit: 'г' },
      { name: 'растительное масло', quantity: 50, unit: 'мл' },
      { name: 'сливочное масло', quantity: 50, unit: 'г' },
      { name: 'чеснок сушеный', quantity: 2, unit: 'ч.л.' },
      { name: 'соль', quantity: 0, unit: 'г' },
    ],
    type: 'первые блюда',
  ...
  },
  {
    ...
    ingredients: [
      { name: 'курица', quantity: 1000, unit: 'г' },
      { name: 'батон', quantity: 250, unit: 'г' },
      { name: 'молоко', quantity: 350, unit: 'мл' },
      { name: 'сливочное масло', quantity: 30, unit: 'г' },
      { name: 'соль', quantity: 0, unit: 'г' }
    ],
    type: 'мясные блюда',
  ...
  },
  {
    ...
    ingredients: [
      { name: 'капуста белокочанная', quantity: 4, unit: 'кг' },
      { name: 'морковь', quantity: 160, unit: 'г' },
      { name: 'соль', quantity: 60, unit: 'г' }
    ],
    type: 'закуски',
